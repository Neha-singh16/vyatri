    ...
    <footer className="text-white" style={{background:"linear-gradient(160deg,#0d1b2a 0%,#1a2f4a 60%,#0d1b2a 100%)"}}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://wa.me/918700289516" target="_blank" rel="noopener noreferrer"
                ...
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white/60 group-hover:fill-green-400 transition-colors">
          ...
          {/* Popular Trips */}
          <div>
            <h4 className="font-bold text-white text-sm uppercase tracking-widest mb-4">Popular Trips</h4>
            <ul className="space-y-2.5">
              {popularTrips.map(l => (
                <li key={l.href}>
                  <Link href={l.href}
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="tel:+918700289516"
                ...
                <Phone size={14} className="flex-shrink-0" /> +91 87002 89516
              </a>
              <a href="mailto:hello@vyatri.in"
                className="flex items-center gap-2.5 text-white/55 hover:text-accent text-sm transition-colors">
                <Mail size={14} className="flex-shrink-0" /> hello@vyatri.in
              </a>
